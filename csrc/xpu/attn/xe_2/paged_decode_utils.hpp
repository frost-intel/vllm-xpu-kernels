...
inline void dispatch_by_head_size(
  ...
  switch (head_case) {
    case 0:
      decode_policy_dispatch_func<decode_policy_xe2<QGroup, _64, PageSize>>(
          queue, cuQKType, args, args.is_causal, args.is_local, args.is_sink);
      break;
    case 1:
      decode_policy_dispatch_func<decode_policy_xe2<QGroup, _96, PageSize>>(
          queue, cuQKType, args, args.is_causal, args.is_local, args.is_sink);
      break;
    case 2:
      decode_policy_dispatch_func<decode_policy_xe2<QGroup, _128, PageSize>>(
          queue, cuQKType, args, args.is_causal, args.is_local, args.is_sink);
      break;
    case 3:
      decode_policy_dispatch_func<decode_policy_xe2<QGroup, _192, PageSize>>(
          queue, cuQKType, args, args.is_causal, args.is_local, args.is_sink);
      break;
    case 4:
      decode_policy_dispatch_func<decode_policy_xe2<QGroup, _256, PageSize>>(
          queue, cuQKType, args, args.is_causal, args.is_local, args.is_sink);
      break;
    case 5:
      decode_policy_dispatch_func<decode_policy_xe2<QGroup, _512, PageSize>>(
          queue, cuQKType, args, args.is_causal, args.is_local, args.is_sink);
      break;
    case 6:
      decode_policy_dispatch_func<decode_policy_xe2<QGroup, _576, PageSize>>(
          queue, cuQKType, args, args.is_causal, args.is_local, args.is_sink);
      break;
    default:
